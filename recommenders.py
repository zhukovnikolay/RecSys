...
class MainRecommender:
    ...
    def __init__(self, data, weighting=True):
        ...
        self.top_purchases = data.groupby(['user_id', 'item_id'])['sales_value'].sum().reset_index()
        ...
        if weighting:
            self.user_item_matrix = bm25_weight(self.user_item_matrix.T, K1=200, B=0.5).T 
    ...
    @staticmethod
    def fit(user_item_matrix, n_factors=100, regularization=0.05, iterations=15, num_threads=4):
        """Обучает ALS"""
